...
struct DSum {
  ...
  inline DSum& DSum::operator=(DSum const &other) {
    if (this == &other) return *this;
    memcpy(sum, other.sum, nbytes);
    return *this;
  }
...
#ifndef NO_STATE_TRANSLATION
State::State(Replica *rep, int total_pages,
#ifdef OBJ_REP
	     int (*gets)(int, char **),
...
#else
void State::cow_single(int i, bool lib_chkpt) {
#endif
