...
# default in the RH7.x distributions.  If "rpmbuild -ba sfs-0.7.spec"
...
# and then run "rpmbuild -ba sfs-0.7.spec --with gcc3".  No gcc3
...
if [ $1 -ge 1 ]; then
# race condition, no condrestart in SFS 0.7
