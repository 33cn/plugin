...
# default in the RH7.x distributions.  If "rpmbuild -ba sfs-0.7.2.spec"
...
# and then run "rpmbuild -ba sfs-0.7.2.spec --with gcc3".  No gcc3
...
if [ $1 -ge 1 ]; then
# race condition, no condrestart in SFS 0.7.2
...
/usr/man/man1/dirsearch.1.gz
/usr/man/man1/newaid.1.gz
...
/usr/man/man7/sfs.7.gz
/usr/man/man8/funmount.8.gz
...
/usr/man/man8/vidb.8.gz
/usr/sbin/sfssd
/usr/sbin/vidb


%changelog
* Fri Dec 20 2002 Kevin Fu <fubob@mit.edu>
- Update for SFS 0.7.2

* Fri Dec 06 2002 Kevin Fu <fubob@mit.edu>
- Update for SFS 0.7.1
