...
func (*ReceiptPBGame) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
func (*PBStartTxReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
func (*PBContinueTxReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (*PBQuitTxReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*PBQueryReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
var fileDescriptor0 = []byte{
	...
	,
}
