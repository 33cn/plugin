...
type TokenAction_TokenMint struct {
	TokenMint *TokenMint `protobuf:"bytes,9,opt,name=tokenMint,oneof"`
}
type TokenAction_TokenBurn struct {
	TokenBurn *TokenBurn `protobuf:"bytes,10,opt,name=tokenBurn,oneof"`
}
...
type TokenPreCreate struct {
	...
	Category     int32  `protobuf:"varint,7,opt,name=category" json:"category,omitempty"`
}
...
func (*TokenMint) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*TokenBurn) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
type Token struct {
	...
	Category     int32  `protobuf:"varint,9,opt,name=category" json:"category,omitempty"`
}
...
type ReceiptTokenAmount struct {
	Prev    *Token `protobuf:"bytes,1,opt,name=prev" json:"prev,omitempty"`
	Current *Token `protobuf:"bytes,2,opt,name=current" json:"current,omitempty"`
}
...
func (*ReceiptTokenAmount) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
type LocalToken struct {
	...
	Category           int32 `protobuf:"varint,17,opt,name=category" json:"category,omitempty"`
}
...
func (*LocalToken) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*LocalLogs) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*ReqTokens) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*ReplyTokens) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*TokenRecv) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*ReplyAddrRecvForTokens) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*ReqTokenBalance) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*ReqAccountTokenAssets) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*TokenAsset) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (*ReplyAccountTokenAssets) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*ReqAddrTokens) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
func (*ReqTokenTx) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
type ReplyTokenLogs struct {
	Logs []*LocalLogs `protobuf:"bytes,1,rep,name=logs" json:"logs,omitempty"`
}
...
func (*ReplyTokenLogs) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
