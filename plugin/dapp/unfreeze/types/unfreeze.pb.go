...
type Unfreeze struct {
	...
	Terminated bool                `protobuf:"varint,12,opt,name=terminated" json:"terminated,omitempty"`
}
...
type LocalUnfreeze struct {
	Unfreeze *Unfreeze `protobuf:"bytes,1,opt,name=unfreeze" json:"unfreeze,omitempty"`
...
func (*LocalUnfreeze) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
type ReqUnfreezes struct {
	...
	FromKey     string `protobuf:"bytes,3,opt,name=fromKey" json:"fromKey,omitempty"`
...
func (*ReqUnfreezes) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*ReplyUnfreeze) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
type ReplyUnfreezes struct {
	Unfreeze []*ReplyUnfreeze `protobuf:"bytes,1,rep,name=unfreeze" json:"unfreeze,omitempty"`
}
...
func (*ReplyUnfreezes) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
