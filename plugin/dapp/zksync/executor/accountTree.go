...
func updateLeafOpt(statedb dbm.KV, accountId uint64, tokenId uint64, option int32) ([]*types.KeyValue, error) {
	var kvs []*types.KeyValue
	...
	leaf.TokenHash, err = getTokenRootHash(statedb, accountId, leaf.TokenIds)
	if err != nil {
