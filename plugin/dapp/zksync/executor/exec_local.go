...
func (z *zksync) ExecLocal_Deposit(payload *zt.ZkDeposit, tx *types.Transaction, receiptData *types.ReceiptData, index int) (*types.LocalDBSet, error) {
	return z.interExecLocalZksyncSpot(tx, receiptData, index)
}
...
func (z *zksync) ExecLocal_ProxyExit(payload *zt.ZkProxyExit, tx *types.Transaction, receiptData *types.ReceiptData, index int) (*types.LocalDBSet, error) {
	return z.interExecLocalZksyncSpot(tx, receiptData, index)
}
