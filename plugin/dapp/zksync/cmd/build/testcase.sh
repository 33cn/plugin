...
function zksync_deposit() {
    ...
    hash=$(${CLI} send zksync l2 deposit -n para -t "${TOKENID_0}" -a 1000000000000000000000 -e 12a0E25E62C1dBD32E505446062B26AECB65F028 -c "$chain33Addr" -i 0 -k 4257D8692EF7FE13C68B65D6A52F03933DB2FA5CE8FAF210B5B8B80C721CED01)
    echo "${hash}"
    query_tx "${CLI}" "${hash}"
...
function zksync_setPubKey() {
    ...
    rawData=$(${CLI} zksync l2 pubkey -a "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
...
function zksync_withdraw() {
    ...
    rawData=$(${CLI} zksync l2 withdraw -t "${TOKENID_0}" -a 100000000 -i "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
...
function zksync_treeToContract() {
    ...
    rawData=$(${CLI} zksync l2 tree2contract -t "${TOKENID_0}" -a 10000000000000000000 --accountId "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
...
function zksync_contractToTree() {
    ...
    chain33Addr=$(${CLI} zksync l2 l2addr -k 6da92a632ab7deb67d38c0f6560bcfed28167998f6496db64c258d5e8393a81b)
    rawData=$(${CLI} zksync l2 contract2tree -t "${TOKENID_0}" -a 1000000000000000000 --accountId "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
    ...
    rawData=$(${CLI} zksync l2 deposit -n para -t "${TOKENID_1}" -a 1000000000 -e abcd68033A72978C1084E2d44D1Fa06DdC4A2d57 -c "$chain33Addr" -i 1)
    echo "${rawData}"
...
function zksync_transferToNew() {
    ...
    rawData=$(${CLI} zksync l2 transfer2new -t "${TOKENID_0}" -a 100000000 -f "${ZKSYNC_ACCOUNT_3}" -e 12a0E25E62C1dBD32E505446062B26AECB65F027 -c "$chain33Addr")
    echo "${rawData}"
...
function zksync_proxyExit() {
    ...
    rawData=$(${CLI} zksync l2 setpubkey -a "${ZKSYNC_ACCOUNT_4}")
    echo "${rawData}"
    ...
    rawData=$(${CLI} zksync l2 proxyexit -t "${TOKENID_0}" -a "${ZKSYNC_ACCOUNT_4}")
    echo "${rawData}"
...
function zksync_fullExit() {
    ...
    rawData=$(${CLI} zksync l2 setpubkey -a 4)
    echo "${rawData}"
    ...
    rawData=$(${CLI} zksync l2 fullexit -n para -t "${TOKENID_0}" -a 4 -i 2)
    echo "${rawData}"
...
function zksync_setVerifyKey() {
    ...
    #set verify key
    rawData=$(${CLI} zksync l2 vkey -n para -v )
    echo "${rawData}"
...
function create_tx() {
    ...
    while true; do
        ...
        rawData=$(${CLI} zksync l2 deposit -n para -t 1 -a 1000000000000 -e abcd68033A72978C1084E2d44D1Fa06DdC4A2d57 -c "$chain33Addr")
        echo "${rawData}"
