...
type ZkOpNFTData struct {
	...
	TokenId         uint64         `protobuf:"varint,1,opt,name=tokenId,proto3" json:"tokenId,omitempty"`
	CreatorId       uint64         `protobuf:"varint,2,opt,name=creatorId,proto3" json:"creatorId,omitempty"`
	CreatorSerialId uint64         `protobuf:"varint,3,opt,name=creatorSerialId,proto3" json:"creatorSerialId,omitempty"`
	ErcProtocol     uint64         `protobuf:"varint,4,opt,name=ercProtocol,proto3" json:"ercProtocol,omitempty"`
...
var file_zksync_proto_rawDesc = []byte{
	...
	0x32, 0x08, 0x0a, 0x06, 0x7a, 0x6b, 0x73, 0x79, 0x6e, 0x63, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x33, 0x33, 0x63, 0x6e, 0x2f, 0x70, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2f, 0x64, 0x61, 0x70, 0x70,
	0x2f, 0x7a, 0x6b, 0x73, 0x79, 0x6e, 0x63, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70,
...
var file_zksync_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_zksync_proto_goTypes = []interface{}{
	...
	(*ZkContentHash)(nil),             // 40: types.ZkContentHash
	(*ZkOpNFTData)(nil),               // 41: types.ZkOpNFTData
	(*ZkOpSwapData)(nil),              // 42: types.ZkOpSwapData
	(*ZkOpFeeData)(nil),               // 43: types.ZkOpFeeData
	(*ZkSetPubKeyData)(nil),           // 44: types.ZkSetPubKeyData
	(*ZkOperation)(nil),               // 45: types.ZkOperation
	(*EthPriorityQueueID)(nil),        // 46: types.EthPriorityQueueID
	(*ReceiptEthPriorityQueueID)(nil), // 47: types.ReceiptEthPriorityQueueID
	(*ZkPubKey)(nil),                  // 48: types.ZkPubKey
	(*AccountProxyPubKeys)(nil),       // 49: types.AccountProxyPubKeys
	(*ZkSignature)(nil),               // 50: types.ZkSignature
	(*OperationInfo)(nil),             // 51: types.OperationInfo
	(*types.KeyValue)(nil),            // 52: types.KeyValue
}
var file_zksync_proto_depIdxs = []int32{
	...
	48, // 18: types.Leaf.pubKey:type_name -> types.ZkPubKey
	49, // 19: types.Leaf.proxyPubKeys:type_name -> types.AccountProxyPubKeys
	48, // 20: types.HistoryLeaf.pubKey:type_name -> types.ZkPubKey
	1,  // 21: types.HistoryLeaf.tokens:type_name -> types.TokenBalance
	49, // 22: types.HistoryLeaf.proxyPubKeys:type_name -> types.AccountProxyPubKeys
	50, // 23: types.ZkDeposit.signature:type_name -> types.ZkSignature
	50, // 24: types.ZkWithdraw.signature:type_name -> types.ZkSignature
	50, // 25: types.ZkContractToTree.signature:type_name -> types.ZkSignature
	50, // 26: types.ZkTreeToContract.signature:type_name -> types.ZkSignature
	50, // 27: types.ZkTransfer.signature:type_name -> types.ZkSignature
	50, // 28: types.ZkTransferToNew.signature:type_name -> types.ZkSignature
	50, // 29: types.ZkForceExit.signature:type_name -> types.ZkSignature
	48, // 30: types.ZkSetPubKey.pubKey:type_name -> types.ZkPubKey
	50, // 31: types.ZkSetPubKey.signature:type_name -> types.ZkSignature
	50, // 32: types.ZkFullExit.signature:type_name -> types.ZkSignature
	50, // 33: types.ZkSwap.signature:type_name -> types.ZkSignature
	50, // 34: types.ZkMintNFT.signature:type_name -> types.ZkSignature
	50, // 35: types.ZkWithdrawNFT.signature:type_name -> types.ZkSignature
	50, // 36: types.ZkTransferNFT.signature:type_name -> types.ZkSignature
	...
	51, // 47: types.ZkQueryResp.operationInfos:type_name -> types.OperationInfo
	3,  // 48: types.ZkQueryResp.leaves:type_name -> types.Leaf
	1,  // 49: types.ZkQueryResp.tokenBalances:type_name -> types.TokenBalance
	51, // 50: types.ZkReceiptLog.operationInfo:type_name -> types.OperationInfo
	52, // 51: types.ZkReceiptLog.localKvs:type_name -> types.KeyValue
	51, // 52: types.ZkQueryProofResp.operationInfos:type_name -> types.OperationInfo
	40, // 53: types.ZkOpNFTData.content:type_name -> types.ZkContentHash
	48, // 54: types.ZkSetPubKeyData.pubKey:type_name -> types.ZkPubKey
	43, // 55: types.ZkOperation.feeData:type_name -> types.ZkOpFeeData
	44, // 56: types.ZkOperation.setPubKey:type_name -> types.ZkSetPubKeyData
	41, // 57: types.ZkOperation.NFTData:type_name -> types.ZkOpNFTData
	42, // 58: types.ZkOperation.swapData:type_name -> types.ZkOpSwapData
