...
func (x *ZkTotalDeposit) Reset() {
	*x = ZkTotalDeposit{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zksync_proto_msgTypes[67]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ZkTotalDeposit) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ZkTotalDeposit) ProtoMessage() {}

func (x *ZkTotalDeposit) ProtoReflect() protoreflect.Message {
	mi := &file_zksync_proto_msgTypes[67]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ZkTotalDeposit.ProtoReflect.Descriptor instead.
func (*ZkTotalDeposit) Descriptor() ([]byte, []int) {
	return file_zksync_proto_rawDescGZIP(), []int{67}
}

func (x *ZkTotalDeposit) GetTokenId() string {
	if x != nil {
		return x.TokenId
	}
	return ""
...
func (x *ZkTotalDeposit) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *ZkTotalDeposit) GetDecimal() uint32 {
	if x != nil {
		return x.Decimal
	}
	return 0
...
func (x *ZkTotalDeposit) GetBalance() string {
	if x != nil {
		return x.Balance
	}
	return ""
...
var file_zksync_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x49, 0x64, 0x22, 0x76, 0x0a, 0x0e, 0x5a, 0x6b, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x44,
	...
	0x52, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x65, 0x63, 0x69,
	0x6d, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x64, 0x65, 0x63, 0x69, 0x6d,
	0x61, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x32, 0x08, 0x0a, 0x06,
...
var file_zksync_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_zksync_proto_goTypes = []interface{}{
	...
	(*ZkTotalDeposit)(nil),             // 67: types.ZkTotalDeposit
	(*types.AssetsTransfer)(nil),       // 68: types.AssetsTransfer
	(*types.AssetsWithdraw)(nil),       // 69: types.AssetsWithdraw
	(*types.AssetsTransferToExec)(nil), // 70: types.AssetsTransferToExec
	(*ZkPubKey)(nil),                   // 71: types.ZkPubKey
	(*AccountProxyPubKeys)(nil),        // 72: types.AccountProxyPubKeys
	(*ZkSignature)(nil),                // 73: types.ZkSignature
	(*ZkFee)(nil),                      // 74: types.ZkFee
	(*OperationInfo)(nil),              // 75: types.OperationInfo
	(*types.KeyValue)(nil),             // 76: types.KeyValue
	(*ZkOperation)(nil),                // 77: types.ZkOperation
}
var file_zksync_proto_depIdxs = []int32{
	...
	68, // 19: types.ZksyncAction.transfer:type_name -> types.AssetsTransfer
	69, // 20: types.ZksyncAction.withdraw:type_name -> types.AssetsWithdraw
	70, // 21: types.ZksyncAction.transferToExec:type_name -> types.AssetsTransferToExec
	7,  // 22: types.AccountTree.subTrees:type_name -> types.SubTree
	71, // 23: types.Leaf.pubKey:type_name -> types.ZkPubKey
	72, // 24: types.Leaf.proxyPubKeys:type_name -> types.AccountProxyPubKeys
	71, // 25: types.HistoryLeaf.pubKey:type_name -> types.ZkPubKey
	2,  // 26: types.HistoryLeaf.tokens:type_name -> types.TokenBalance
	72, // 27: types.HistoryLeaf.proxyPubKeys:type_name -> types.AccountProxyPubKeys
	73, // 28: types.ZkDeposit.signature:type_name -> types.ZkSignature
	73, // 29: types.ZkWithdraw.signature:type_name -> types.ZkSignature
	73, // 30: types.ZkContractToTree.signature:type_name -> types.ZkSignature
	73, // 31: types.ZkTreeToContract.signature:type_name -> types.ZkSignature
	73, // 32: types.ZkTransfer.signature:type_name -> types.ZkSignature
	73, // 33: types.ZkTransferToNew.signature:type_name -> types.ZkSignature
	73, // 34: types.ZkForceExit.signature:type_name -> types.ZkSignature
	73, // 35: types.ZkProxyExit.signature:type_name -> types.ZkSignature
	74, // 36: types.ZkProxyExit.fee:type_name -> types.ZkFee
	71, // 37: types.ZkSetPubKey.pubKey:type_name -> types.ZkPubKey
	73, // 38: types.ZkSetPubKey.signature:type_name -> types.ZkSignature
	73, // 39: types.ZkFullExit.signature:type_name -> types.ZkSignature
	73, // 40: types.ZkSwap.signature:type_name -> types.ZkSignature
	73, // 41: types.ZkMintNFT.signature:type_name -> types.ZkSignature
	73, // 42: types.ZkWithdrawNFT.signature:type_name -> types.ZkSignature
	73, // 43: types.ZkTransferNFT.signature:type_name -> types.ZkSignature
	...
	75, // 53: types.ZkQueryResp.operationInfos:type_name -> types.OperationInfo
	4,  // 54: types.ZkQueryResp.leaves:type_name -> types.Leaf
	2,  // 55: types.ZkQueryResp.tokenBalances:type_name -> types.TokenBalance
	75, // 56: types.ZkReceiptLog.operationInfo:type_name -> types.OperationInfo
	76, // 57: types.ZkReceiptLog.localKvs:type_name -> types.KeyValue
	75, // 58: types.ZkQueryProofResp.operationInfos:type_name -> types.OperationInfo
	42, // 59: types.ZkOpNFTData.content:type_name -> types.ZkContentHash
	71, // 60: types.ZkSetPubKeyData.pubKey:type_name -> types.ZkPubKey
	...
	77, // 69: types.ReceiptL2QueueIDData.op:type_name -> types.ZkOperation
...
func file_zksync_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_zksync_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ZkTotalDeposit); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
