...
var file_zksync_proto_rawDesc = []byte{
	...
	0x6f, 0x66, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x9a, 0x02, 0x0a, 0x10, 0x5a, 0x6b,
...
var file_zksync_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_zksync_proto_goTypes = []interface{}{
	...
	(*ZkNFTTokenStatus)(nil),          // 12: types.ZkNFTTokenStatus
	(*ZkVerifyKey)(nil),               // 13: types.ZkVerifyKey
	(*ReceiptSetVerifyKey)(nil),       // 14: types.ReceiptSetVerifyKey
	(*ZkFeeAddrs)(nil),                // 15: types.ZkFeeAddrs
	(*ZkCommitProof)(nil),             // 16: types.ZkCommitProof
	(*CommitProofState)(nil),          // 17: types.CommitProofState
	(*LastOnChainProof)(nil),          // 18: types.LastOnChainProof
	(*ReceiptCommitProof)(nil),        // 19: types.ReceiptCommitProof
	(*ReceiptCommitProofRecord)(nil),  // 20: types.ReceiptCommitProofRecord
	(*ZkVerifier)(nil),                // 21: types.ZkVerifier
	(*ReceiptSetVerifier)(nil),        // 22: types.ReceiptSetVerifier
	(*ZkSetFee)(nil),                  // 23: types.ZkSetFee
	(*ReceiptSetFee)(nil),             // 24: types.ReceiptSetFee
	...
	(*ZkQueryTxOperationReq)(nil),     // 31: types.ZkQueryTxOperationReq
	(*ZkQueryProofResp)(nil),          // 32: types.ZkQueryProofResp
	(*ZkChainTitle)(nil),              // 33: types.ZkChainTitle
	(*ZkChainTitleList)(nil),          // 34: types.ZkChainTitleList
	(*ZkFetchProofList)(nil),          // 35: types.ZkFetchProofList
	(*ZkContentHash)(nil),             // 36: types.ZkContentHash
	(*ZkOpNFTData)(nil),               // 37: types.ZkOpNFTData
	(*ZkOpSwapData)(nil),              // 38: types.ZkOpSwapData
	(*ZkOpFeeData)(nil),               // 39: types.ZkOpFeeData
	(*ZkSetPubKeyData)(nil),           // 40: types.ZkSetPubKeyData
	(*ZkOperation)(nil),               // 41: types.ZkOperation
	(*EthPriorityQueueID)(nil),        // 42: types.EthPriorityQueueID
	(*ReceiptEthPriorityQueueID)(nil), // 43: types.ReceiptEthPriorityQueueID
	(*ZkDeposit)(nil),                 // 44: types.ZkDeposit
	(*ZkWithdraw)(nil),                // 45: types.ZkWithdraw
	(*ZkTransfer)(nil),                // 46: types.ZkTransfer
	(*ZkTransferToNew)(nil),           // 47: types.ZkTransferToNew
	(*ZkProxyExit)(nil),               // 48: types.ZkProxyExit
	(*ZkSetPubKey)(nil),               // 49: types.ZkSetPubKey
	(*ZkFullExit)(nil),                // 50: types.ZkFullExit
	(*ZkSwap)(nil),                    // 51: types.ZkSwap
	(*ZkContractToTree)(nil),          // 52: types.ZkContractToTree
	(*ZkTreeToContract)(nil),          // 53: types.ZkTreeToContract
	(*ZkMintNFT)(nil),                 // 54: types.ZkMintNFT
	(*ZkWithdrawNFT)(nil),             // 55: types.ZkWithdrawNFT
	(*ZkTransferNFT)(nil),             // 56: types.ZkTransferNFT
...
var file_zksync_proto_depIdxs = []int32{
	44, // 0: types.ZksyncAction.deposit:type_name -> types.ZkDeposit
	45, // 1: types.ZksyncAction.withdraw:type_name -> types.ZkWithdraw
	46, // 2: types.ZksyncAction.transfer:type_name -> types.ZkTransfer
	47, // 3: types.ZksyncAction.transferToNew:type_name -> types.ZkTransferToNew
	48, // 4: types.ZksyncAction.proxyExit:type_name -> types.ZkProxyExit
	49, // 5: types.ZksyncAction.setPubKey:type_name -> types.ZkSetPubKey
	50, // 6: types.ZksyncAction.fullExit:type_name -> types.ZkFullExit
	51, // 7: types.ZksyncAction.swap:type_name -> types.ZkSwap
	52, // 8: types.ZksyncAction.contractToTree:type_name -> types.ZkContractToTree
	53, // 9: types.ZksyncAction.treeToContract:type_name -> types.ZkTreeToContract
	54, // 10: types.ZksyncAction.mintNFT:type_name -> types.ZkMintNFT
	55, // 11: types.ZksyncAction.withdrawNFT:type_name -> types.ZkWithdrawNFT
	56, // 12: types.ZksyncAction.transferNFT:type_name -> types.ZkTransferNFT
	13, // 13: types.ZksyncAction.setVerifyKey:type_name -> types.ZkVerifyKey
	16, // 14: types.ZksyncAction.commitProof:type_name -> types.ZkCommitProof
	21, // 15: types.ZksyncAction.setVerifier:type_name -> types.ZkVerifier
	23, // 16: types.ZksyncAction.setFee:type_name -> types.ZkSetFee
	...
	13, // 28: types.ReceiptSetVerifyKey.prev:type_name -> types.ZkVerifyKey
	13, // 29: types.ReceiptSetVerifyKey.current:type_name -> types.ZkVerifyKey
	15, // 30: types.ZkCommitProof.cfgFeeAddrs:type_name -> types.ZkFeeAddrs
	17, // 31: types.ReceiptCommitProof.prev:type_name -> types.CommitProofState
	17, // 32: types.ReceiptCommitProof.current:type_name -> types.CommitProofState
	17, // 33: types.ReceiptCommitProofRecord.proof:type_name -> types.CommitProofState
	21, // 34: types.ReceiptSetVerifier.prev:type_name -> types.ZkVerifier
	21, // 35: types.ReceiptSetVerifier.current:type_name -> types.ZkVerifier
	3,  // 36: types.ZkReceiptLeaf.leaf:type_name -> types.Leaf
	1,  // 37: types.ZkReceiptLeaf.token:type_name -> types.TokenBalance
	8,  // 38: types.ZkReceiptLeaf.treeProof:type_name -> types.MerkleTreeProof
	8,  // 39: types.ZkReceiptLeaf.tokenProof:type_name -> types.MerkleTreeProof
	59, // 40: types.ZkQueryResp.operationInfos:type_name -> types.OperationInfo
	3,  // 41: types.ZkQueryResp.leaves:type_name -> types.Leaf
	1,  // 42: types.ZkQueryResp.tokenBalances:type_name -> types.TokenBalance
	59, // 43: types.ZkReceiptLog.operationInfo:type_name -> types.OperationInfo
	60, // 44: types.ZkReceiptLog.localKvs:type_name -> types.KeyValue
	59, // 45: types.ZkQueryProofResp.operationInfos:type_name -> types.OperationInfo
	33, // 46: types.ZkChainTitleList.chains:type_name -> types.ZkChainTitle
	36, // 47: types.ZkOpNFTData.content:type_name -> types.ZkContentHash
	57, // 48: types.ZkSetPubKeyData.pubKey:type_name -> types.ZkPubKey
	39, // 49: types.ZkOperation.feeData:type_name -> types.ZkOpFeeData
	40, // 50: types.ZkOperation.setPubKey:type_name -> types.ZkSetPubKeyData
	37, // 51: types.ZkOperation.NFTData:type_name -> types.ZkOpNFTData
	38, // 52: types.ZkOperation.swapData:type_name -> types.ZkOpSwapData
