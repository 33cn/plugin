...
type ZkExodusPauseModeParm struct {
	...
	Value uint32 `protobuf:"varint,1,opt,name=value,proto3" json:"value,omitempty"` //1: 设置pause，0：restore pause
}
...
func (x *ZkExodusPauseModeParm) GetValue() uint32 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_zksync_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x0f, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63,
