...
type ZkDepositReceiptLog struct {
...
func (x *ZkDepositReceiptLog) Reset() {
	*x = ZkDepositReceiptLog{}
...
func (x *ZkDepositReceiptLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ZkDepositReceiptLog) ProtoMessage() {}

func (x *ZkDepositReceiptLog) ProtoReflect() protoreflect.Message {
	mi := &file_receipt_proto_msgTypes[0]
...
// Deprecated: Use ZkDepositReceiptLog.ProtoReflect.Descriptor instead.
func (*ZkDepositReceiptLog) Descriptor() ([]byte, []int) {
	return file_receipt_proto_rawDescGZIP(), []int{0}
}

func (x *ZkDepositReceiptLog) GetAccountId() uint64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *ZkDepositReceiptLog) GetEthAddress() string {
	if x != nil {
		return x.EthAddress
	}
	return ""
...
func (x *ZkDepositReceiptLog) GetChain33Addr() string {
	if x != nil {
...
func (x *ZkDepositReceiptLog) GetTokenId() uint64 {
	if x != nil {
		return x.TokenId
	}
	return 0
...
func (x *ZkDepositReceiptLog) GetBalanceBefore() string {
	if x != nil {
...
func (x *ZkDepositReceiptLog) GetBalanceAfter() string {
	if x != nil {
...
var file_receipt_proto_rawDesc = []byte{
	...
	0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0xd9, 0x01, 0x0a, 0x13, 0x5a, 0x6b, 0x44, 0x65, 0x70,
	0x6f, 0x73, 0x69, 0x74, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x4c, 0x6f, 0x67, 0x12, 0x1c,
	...
	,
...
var file_receipt_proto_goTypes = []interface{}{
	(*ZkDepositReceiptLog)(nil), // 0: types.ZkDepositReceiptLog
}
...
func file_receipt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_receipt_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ZkDepositReceiptLog); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
