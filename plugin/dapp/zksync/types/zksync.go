...
var (
	...
	logMap = map[int64]*types.LogInfo{
		...
		TyContractToTreeLog: {Ty: reflect.TypeOf(ZkReceiptLeaf{}), Name: "TyContractToTreeLog"},
		TyTreeToContractLog: {Ty: reflect.TypeOf(ZkReceiptLeaf{}), Name: "TyTreeToContractLog"},
		...
		TyFullExitLog:       {Ty: reflect.TypeOf(ZkReceiptLeaf{}), Name: "TyFullExitLog"},
		TySwapLog:           {Ty: reflect.TypeOf(ZkReceiptLeaf{}), Name: "TySwapLog"},
