...
var (
	...
	logMap = map[int64]*types.LogInfo{
		...
		TyTransferLog:           {Ty: reflect.TypeOf(AccountTokenBalanceReceipt{}), Name: "TyTransferLog"},
		TyTransferToNewLog:      {Ty: reflect.TypeOf(AccountTokenBalanceReceipt{}), Name: "TyTransferToNewLog"},
		TyForceExitLog:          {Ty: reflect.TypeOf(AccountTokenBalanceReceipt{}), Name: "TyForceExitLog"},
		...
		TyTransferNFTLog:        {Ty: reflect.TypeOf(TransferReceipt{}), Name: "TyTransferNFTLog"},
