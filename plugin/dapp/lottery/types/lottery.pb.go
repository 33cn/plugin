...
type Lottery struct {
	...
	OpRewardRatio              int64              `protobuf:"varint,18,opt,name=opRewardRatio" json:"opRewardRatio,omitempty"`
	DevRewardRatio             int64              `protobuf:"varint,19,opt,name=devRewardRatio" json:"devRewardRatio,omitempty"`
	PurRecords                 []*PurchaseRecords `protobuf:"bytes,20,rep,name=purRecords" json:"purRecords,omitempty"`
	TotalAddrNum               int64              `protobuf:"varint,21,opt,name=totalAddrNum" json:"totalAddrNum,omitempty"`
	BuyAmount                  int64              `protobuf:"varint,22,opt,name=buyAmount" json:"buyAmount,omitempty"`
}
...
type LotteryCreate struct {
	...
	OpRewardRatio  int64 `protobuf:"varint,3,opt,name=opRewardRatio" json:"opRewardRatio,omitempty"`
	DevRewardRatio int64 `protobuf:"varint,4,opt,name=devRewardRatio" json:"devRewardRatio,omitempty"`
}
...
type ReceiptLottery struct {
	...
	BuyAmount    int64                 `protobuf:"varint,15,opt,name=buyAmount" json:"buyAmount,omitempty"`
	GainInfos    *LotteryGainInfos     `protobuf:"bytes,16,opt,name=gainInfos" json:"gainInfos,omitempty"`
	LuckyAddrNum int64                 `protobuf:"varint,17,opt,name=luckyAddrNum" json:"luckyAddrNum,omitempty"`
	TotalFund    int64                 `protobuf:"varint,18,opt,name=totalFund" json:"totalFund,omitempty"`
	Factor       int64                 `protobuf:"varint,19,opt,name=factor" json:"factor,omitempty"`
}
...
type ReplyLotteryNormalInfo struct {
	...
	OpRewardRatio  int64  `protobuf:"varint,5,opt,name=opRewardRatio" json:"opRewardRatio,omitempty"`
	DevRewardRatio int64  `protobuf:"varint,6,opt,name=devRewardRatio" json:"devRewardRatio,omitempty"`
}
...
type ReplyLotteryCurrentInfo struct {
	...
	TotalAddrNum               int64            `protobuf:"varint,13,opt,name=totalAddrNum" json:"totalAddrNum,omitempty"`
	BuyAmount                  int64            `protobuf:"varint,14,opt,name=buyAmount" json:"buyAmount,omitempty"`
}
...
type LotteryDrawRecord struct {
	...
	TotalAddrNum int64  `protobuf:"varint,5,opt,name=totalAddrNum" json:"totalAddrNum,omitempty"`
	BuyAmount    int64  `protobuf:"varint,6,opt,name=buyAmount" json:"buyAmount,omitempty"`
	LuckyAddrNum int64  `protobuf:"varint,7,opt,name=luckyAddrNum" json:"luckyAddrNum,omitempty"`
	TotalFund    int64  `protobuf:"varint,8,opt,name=totalFund" json:"totalFund,omitempty"`
	Factor       int64  `protobuf:"varint,9,opt,name=factor" json:"factor,omitempty"`
}
...
type LotteryGainInfos struct {
	Gains []*LotteryGainInfo `protobuf:"bytes,1,rep,name=gains" json:"gains,omitempty"`
}
...
func (*LotteryGainInfos) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*LotteryGainInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*LotteryGainRecord) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
type LotteryGainRecords struct {
	Records []*LotteryGainRecord `protobuf:"bytes,1,rep,name=records" json:"records,omitempty"`
}
...
func (*LotteryGainRecords) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*ReqLotteryGainHistory) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*ReqLotteryGainInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
