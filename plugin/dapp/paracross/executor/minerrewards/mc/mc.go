...
const (
	...
	addrStaffA = "1CdECPZbnm6zaFF1CvkXn4nMKhwYbNBLN5:1875" //18.75quota 1875/10000
	addrStaffB = "1DV7mnSCXmt5dWyAX8nKqjSgkby1J6vZME:1875" //18.75 quota
	addrBoss   = "1ARyjNWRY71mJvzQ5RuU3wgvKMaZSY8Qeb:6250" //62.50 quota
...
func init() {
	minerrewards.Register("mc", &custom{})
	checkQuota()
}
...
//按照40960*(2^n -1)获得的n的高度
func getNHeight(n uint32) int64 {
	v := 1 << n
	return 40960 * (int64(v) - 1)
}

//按照平行链上0高度对应旧链n=6,height=2580480时候高度，在n>6时，平行链实际的高度
func getOffsetNHeight(n uint32) int64 {
	return getNHeight(n) - getNHeight(6)
}
...
func (c *custom) RewardMiners(cfg *types.Chain33Config, coinReward int64, miners []string, height int64) ([]*pt.ParaMinerReward, int64) {
	//找零
	var change int64
