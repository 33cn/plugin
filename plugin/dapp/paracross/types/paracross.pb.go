...
func (*ParacrossStatusDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{0}
}
...
func (*ParacrossStatusBlockDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{1}
}
...
func (*ParacrossHeightStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{2}
}
...
func (*ParacrossHeightStatusRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{3}
}
...
func (*ParacrossStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{4}
}
...
func (*ParacrossConsensusStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{5}
}
...
func (*ParaNodeAddrConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{6}
}
...
func (*ParaNodeVoteDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{7}
}
...
func (*ParaNodeAddrIdStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{8}
}
...
func (*ParaNodeIdStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{9}
}
...
func (*ReceiptParaNodeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{10}
}
...
func (*ReceiptParaNodeAddrStatUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{11}
}
...
func (*ReceiptParaNodeVoteDone) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{12}
}
...
func (*ParaNodeGroupConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{13}
}
...
func (*ReqParaNodeAddrPubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{14}
}
func (m *ReqParaNodeAddrPubKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReqParaNodeAddrPubKey.Unmarshal(m, b)
}
func (m *ReqParaNodeAddrPubKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReqParaNodeAddrPubKey.Marshal(b, m, deterministic)
}
func (dst *ReqParaNodeAddrPubKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReqParaNodeAddrPubKey.Merge(dst, src)
}
func (m *ReqParaNodeAddrPubKey) XXX_Size() int {
	return xxx_messageInfo_ReqParaNodeAddrPubKey.Size(m)
}
func (m *ReqParaNodeAddrPubKey) XXX_DiscardUnknown() {
	xxx_messageInfo_ReqParaNodeAddrPubKey.DiscardUnknown(m)
}

var xxx_messageInfo_ReqParaNodeAddrPubKey proto.InternalMessageInfo
...
type ParaNodeAddrPubKey struct {
	Addr2Pubkey          map[string][]byte `protobuf:"bytes,1,rep,name=addr2pubkey,proto3" json:"addr2pubkey,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*ParaNodeAddrPubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{15}
}
func (m *ParaNodeAddrPubKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ParaNodeAddrPubKey.Unmarshal(m, b)
}
func (m *ParaNodeAddrPubKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ParaNodeAddrPubKey.Marshal(b, m, deterministic)
}
func (dst *ParaNodeAddrPubKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParaNodeAddrPubKey.Merge(dst, src)
}
func (m *ParaNodeAddrPubKey) XXX_Size() int {
	return xxx_messageInfo_ParaNodeAddrPubKey.Size(m)
}
func (m *ParaNodeAddrPubKey) XXX_DiscardUnknown() {
	xxx_messageInfo_ParaNodeAddrPubKey.DiscardUnknown(m)
}

var xxx_messageInfo_ParaNodeAddrPubKey proto.InternalMessageInfo
...
func (*AddrAndPubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{16}
}
func (m *AddrAndPubKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AddrAndPubKey.Unmarshal(m, b)
}
func (m *AddrAndPubKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AddrAndPubKey.Marshal(b, m, deterministic)
}
func (dst *AddrAndPubKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddrAndPubKey.Merge(dst, src)
}
func (m *AddrAndPubKey) XXX_Size() int {
	return xxx_messageInfo_AddrAndPubKey.Size(m)
}
func (m *AddrAndPubKey) XXX_DiscardUnknown() {
	xxx_messageInfo_AddrAndPubKey.DiscardUnknown(m)
}

var xxx_messageInfo_AddrAndPubKey proto.InternalMessageInfo
...
type RespParaNodeAddrPubKey struct {
	AddrAndPubKey        []*AddrAndPubKey `protobuf:"bytes,1,rep,name=addrAndPubKey,proto3" json:"addrAndPubKey,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*RespParaNodeAddrPubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{17}
}
func (m *RespParaNodeAddrPubKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RespParaNodeAddrPubKey.Unmarshal(m, b)
}
func (m *RespParaNodeAddrPubKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RespParaNodeAddrPubKey.Marshal(b, m, deterministic)
}
func (dst *RespParaNodeAddrPubKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RespParaNodeAddrPubKey.Merge(dst, src)
}
func (m *RespParaNodeAddrPubKey) XXX_Size() int {
	return xxx_messageInfo_RespParaNodeAddrPubKey.Size(m)
}
func (m *RespParaNodeAddrPubKey) XXX_DiscardUnknown() {
	xxx_messageInfo_RespParaNodeAddrPubKey.DiscardUnknown(m)
}

var xxx_messageInfo_RespParaNodeAddrPubKey proto.InternalMessageInfo
...
func (*ReqConverTx2Privacy) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{18}
}
func (m *ReqConverTx2Privacy) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReqConverTx2Privacy.Unmarshal(m, b)
}
func (m *ReqConverTx2Privacy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReqConverTx2Privacy.Marshal(b, m, deterministic)
}
func (dst *ReqConverTx2Privacy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReqConverTx2Privacy.Merge(dst, src)
}
func (m *ReqConverTx2Privacy) XXX_Size() int {
	return xxx_messageInfo_ReqConverTx2Privacy.Size(m)
}
func (m *ReqConverTx2Privacy) XXX_DiscardUnknown() {
	xxx_messageInfo_ReqConverTx2Privacy.DiscardUnknown(m)
}

var xxx_messageInfo_ReqConverTx2Privacy proto.InternalMessageInfo
...
func (*ParaNodeGroupStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{19}
}
...
func (*ReceiptParaNodeGroupConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{20}
}
...
func (*ReqParacrossNodeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{21}
}
...
func (*RespParacrossNodeAddrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{22}
}
...
func (*RespParacrossNodeGroups) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{23}
}
...
func (*ParaBlock2MainMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{24}
}
...
func (*ParaBlock2MainInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{25}
}
...
func (*ParacrossNodeStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{26}
}
...
func (*SelfConsensStages) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{27}
}
...
func (*SelfConsensStage) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{28}
}
...
func (*SelfConsensStageInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{29}
}
...
func (*LocalSelfConsStageInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{30}
}
...
func (*ConfigVoteInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{31}
}
...
func (*ConfigCancelInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{32}
}
...
func (*ParaStageConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{33}
}
...
func (*ReceiptSelfConsStageConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{34}
}
...
func (*ReceiptSelfConsStageVoteDone) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{35}
}
...
func (*ReceiptSelfConsStagesUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{36}
}
...
func (*ReqQuerySelfStages) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{37}
}
...
func (*ReplyQuerySelfStages) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{38}
}
...
func (*ParacrossCommitAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{39}
}
...
func (*ParacrossMinerAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{40}
}
...
func (*ParacrossAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{41}
}
...
func (*ReceiptParacrossCommit) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{42}
}
...
func (*ReceiptParacrossMiner) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{43}
}
...
func (*ReceiptParacrossDone) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{44}
}
...
func (*ReceiptParacrossRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{45}
}
...
func (*ParacrossTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{46}
}
...
func (*ReqParacrossTitleHeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{47}
}
...
func (*RespParacrossDone) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{48}
}
...
func (*RespParacrossTitles) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{49}
}
...
func (*ReqParacrossTitleHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{50}
}
...
func (*ParacrossAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{51}
}
...
func (*ParacrossAssetRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{52}
}
...
func (*ParaLocalDbBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{53}
}
...
func (*ParaLocalDbBlockInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_paracross_ee6d863a7ad77c1a, []int{54}
}
...
func init() {
	...
	proto.RegisterMapType((map[string][]byte)(nil), "types.ParaNodeAddrPubKey.Addr2pubkeyEntry")
...
func init() { proto.RegisterFile("paracross.proto", fileDescriptor_paracross_ee6d863a7ad77c1a) }

var fileDescriptor_paracross_ee6d863a7ad77c1a = []byte{
	// 2548 bytes of a gzipped FileDescriptorProto
	,
}
