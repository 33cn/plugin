...
type ParacrossAssetRsp struct {
	...
	From       string `protobuf:"bytes,1,opt,name=from" json:"from,omitempty"`
	To         string `protobuf:"bytes,2,opt,name=to" json:"to,omitempty"`
	IsWithdraw string `protobuf:"bytes,3,opt,name=isWithdraw" json:"isWithdraw,omitempty"`
	...
	CommitDoneHeight int64  `protobuf:"varint,21,opt,name=commitDoneHeight" json:"commitDoneHeight,omitempty"`
	ParaHeight       int64  `protobuf:"varint,22,opt,name=paraHeight" json:"paraHeight,omitempty"`
	Success          string `protobuf:"bytes,23,opt,name=success" json:"success,omitempty"`
}
...
func (*ParacrossAssetRsp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52} }
...
func (*ParaLocalDbBlock) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{53} }
...
func (*ParaLocalDbBlockInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }
...
type ParacrossClient interface {
	...
	GetAssetTxResult(ctx context.Context, in *types1.ReqString, opts ...grpc.CallOption) (*ParacrossAssetRsp, error)
...
func (c *paracrossClient) GetAssetTxResult(ctx context.Context, in *types1.ReqString, opts ...grpc.CallOption) (*ParacrossAssetRsp, error) {
...
type ParacrossServer interface {
	...
	GetAssetTxResult(context.Context, *types1.ReqString) (*ParacrossAssetRsp, error)
...
func _Paracross_GetAssetTxResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParacrossServer).GetAssetTxResult(ctx, req.(*types1.ReqString))
	}
	return interceptor(ctx, in, info, handler)
}
