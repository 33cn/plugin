...
type ReceiptParaNodeVoteDone struct {
	...
	VoteRst              bool     `protobuf:"varint,6,opt,name=voteRst,proto3" json:"voteRst,omitempty"`
...
func (m *ReceiptParaNodeVoteDone) GetVoteRst() bool {
	if m != nil {
		return m.VoteRst
	}
	return false
...
type RespParacrossNodeAddrs struct {
	Addrs                []*ReceiptParaNodeVoteDone `protobuf:"bytes,1,rep,name=addrs,proto3" json:"addrs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *RespParacrossNodeAddrs) GetAddrs() []*ReceiptParaNodeVoteDone {
	if m != nil {
		return m.Addrs
	}
	return nil
...
var fileDescriptor_6a397e38c9ea6747 = []byte{
	...
	,
}
