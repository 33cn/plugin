...
type OracleStatus struct {
	...
	Status       *EventStatus `protobuf:"bytes,8,opt,name=status" json:"status,omitempty"`
	Source       string       `protobuf:"bytes,9,opt,name=source" json:"source,omitempty"`
	Result       string       `protobuf:"bytes,10,opt,name=result" json:"result,omitempty"`
	PreStatus    *EventStatus `protobuf:"bytes,11,opt,name=preStatus" json:"preStatus,omitempty"`
}
...
func (*OracleStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*OracleAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type OracleAction_EventPublish struct {
	EventPublish *EventPublish `protobuf:"bytes,1,opt,name=eventPublish,oneof"`
}
type OracleAction_EventAbort struct {
	EventAbort *EventAbort `protobuf:"bytes,2,opt,name=eventAbort,oneof"`
}
type OracleAction_ResultPrePublish struct {
	ResultPrePublish *ResultPrePublish `protobuf:"bytes,3,opt,name=resultPrePublish,oneof"`
}
type OracleAction_ResultPublish struct {
	ResultPublish *ResultPublish `protobuf:"bytes,4,opt,name=resultPublish,oneof"`
}
type OracleAction_ResultAbort struct {
	ResultAbort *ResultAbort `protobuf:"bytes,5,opt,name=resultAbort,oneof"`
}
...
type EventStatus struct {
	OpAddr string `protobuf:"bytes,1,opt,name=opAddr" json:"opAddr,omitempty"`
...
func (*EventStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type EventPublish struct {
	...
	Introduction string `protobuf:"bytes,6,opt,name=introduction" json:"introduction,omitempty"`
}
...
func (*EventPublish) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*EventAbort) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*ResultPrePublish) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*ResultPublish) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*ResultAbort) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*EventRecord) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
type QueryOracleInfos struct {
	EventID []string `protobuf:"bytes,1,rep,name=eventID" json:"eventID,omitempty"`
}
...
func (*QueryOracleInfos) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*ReplyEventIDs) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*QueryEventID) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
type ReceiptOracle struct {
	...
	PreStatus int32  `protobuf:"varint,6,opt,name=preStatus" json:"preStatus,omitempty"`
}
...
func (*ReceiptOracle) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
type ReplyOracleStatusList struct {
	Status []*OracleStatus `protobuf:"bytes,1,rep,name=status" json:"status,omitempty"`
}
...
func (*ReplyOracleStatusList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func init() { proto.RegisterFile("oracle.proto", fileDescriptor0) }
