...
func (p *Pos33) ExecDelLocal_Deposit(act *pt.Pos33DepositAction, tx *types.Transaction, index int) (*types.Receipt, error) {
	return p.deposit(-int(act.W), tx)
}

// ExecDelLocal_Withdraw for rollback withdraw
func (p *Pos33) ExecDelLocal_Withdraw(act *pt.Pos33WithdrawAction, tx *types.Transaction, index int) (*types.Receipt, error) {
	return p.deposit(-int(act.W), tx)
}

// ExecDelLocal_Delegate for rollback delegate
func (p *Pos33) ExecDelLocal_Delegate(act *pt.Pos33DelegateAction, tx *types.Transaction, index int) (*types.Receipt, error) {
	return nil, nil
}

// ExecDelLocal_Reword for rollback reword
func (p *Pos33) ExecDelLocal_Reword(act *pt.Pos33RewordAction, tx *types.Transaction, index int) (*types.Receipt, error) {
	return nil, nil
}

// ExecDelLocal_Punish for rollback punish
func (p *Pos33) ExecDelLocal_Punish(act *pt.Pos33PunishAction, tx *types.Transaction, index int) (*types.Receipt, error) {
	return nil, nil
}
