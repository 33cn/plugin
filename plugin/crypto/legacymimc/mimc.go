...
// Package legacymimc 提供 gnark-crypto v0.5.3 的旧版 MiMC 实现。
// chain33 升级 go-ethereum v1.14.8 后 gnark-crypto 升至 v0.12.1，
// 其 MiMC round constants 从 sha3.Sum256 改为 keccak256，导致 hash 输出变化。
// 为保持 zksync/mix 链上已有数据兼容，保留旧实现。
package legacymimc
...
// Size returns the hash's underlying block size.
...
// checksum hash using Miyaguchi–Preneel:
...
// encrypt plain execution of a mimc run
// m: message, k: encryption key
